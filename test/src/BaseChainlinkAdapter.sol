...
import {AggregatorV3Interface} from "../../src/interfaces/radiant-interfaces/AggregatorV3Interface.sol";
...
abstract contract BaseChainlinkAdapter is AggregatorV3Interface {
    ...
    function validate(int256 _answer, uint256 _updatedAt) public view {
        ...
        if (
            heartbeat > 0 &&
            block.timestamp - _updatedAt >= heartbeat + HEART_BEAT_TOLERANCE
        ) revert StalePrice();
