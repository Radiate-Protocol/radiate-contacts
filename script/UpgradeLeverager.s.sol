...
// forge script UpgradeLeverager --rpc-url $ARBITRUM_RPC_URL --broadcast --verify -slow -vv
// forge script UpgradeLeverager --rpc-url $ARBITRUM_RPC_URL --private-key $PRIVATE_KEY --broadcast --verify --skip-simulation --slow -vvvv
contract UpgradeLeverager is Script, AddressProvider {
    // Deploy config
